package alarmsystem;package alarmsystem;package alarmsystem;package alarmsystem;package alarmsystem;
...
public class CorbaClient {import java.nio.file.Files;

    public static void main(String[] args) {

        try {import java.nio.file.Paths;import java.io.IOException;
            ...
            // Read the IOR from filepublic class CorbaClient {import java.nio.file.Files;
            ...
            org.omg.CORBA.Object obj = orb.string_to_object(ior);        try {import java.nio.file.Paths;import java.io.IOException;import java.io.IOException;

            

            // Narrow to Alarm interface            // Initialize ORB

            Alarm alarm = AlarmHelper.narrow(obj);

                        org.omg.CORBA.ORB orb = org.omg.CORBA.ORB.init(args, null);

            // Call methods and output JSON (including ALMA-style getAlarmById)

            System.out.println("{");            

            System.out.println("  \"id\": \"" + alarm.getAlarmById("999") + "\",");

            System.out.println("  \"action\": \"" + alarm.getAction() + "\",");            // Read the IOR from filepublic class CorbaClient {import java.nio.file.Files;import java.nio.file.Files;

            System.out.println("  \"priority\": " + alarm.getPriority() + ",");

            System.out.println("  \"status\": \"" + alarm.getStatus() + "\",");            String ior = new String(Files.readAllBytes(Paths.get("Alarm.ref"))).trim();
        ...
        } catch (Exception e) {            // Convert IOR to object reference

            System.err.println("Error: " + e.getMessage());

            System.exit(1);            org.omg.CORBA.Object obj = orb.string_to_object(ior);        try {import java.nio.file.Paths;import java.nio.file.Paths;
            ...
            System.out.println("  \"action\": \"" + alarm.getAction() + "\",");            // Read the IOR from filepublic class CorbaClient {public class CorbaClient {
            ...
            System.out.println("}");                public static void main(String[] args) {    public static void main(String[] args) {
            ...
            System.exit(1);            org.omg.CORBA.Object obj = orb.string_to_object(ior);        try {        try {
