...
public class AlarmImpl extends AlarmPOA {
    ...
    // ALMA-style getAlarmById methodpublic class AlarmImpl extends CERNAlarmServicePOA {

    @Override

    public String getAlarmId() {    @Override
    ...
    public int getPriority() {
        ...
        return 1;    }    // ALMA-style getAlarmById method - returns JSON string for nowpublic class AlarmImpl extends CERNAlarmServicePOA {public class AlarmImpl extends CERNAlarmServicePOA {
