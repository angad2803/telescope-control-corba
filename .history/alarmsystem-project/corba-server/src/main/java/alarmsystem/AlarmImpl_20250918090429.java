...
public class AlarmImpl extends AlarmPOA {
    ...
    public String getAction() {
        ...
        return "REAL CORBA: Emergency shutdown sequence";    public String getAlarmById(String id) {        
    ...
    public String getAlarmId() {    }    // ALMA-compliant getAlarmById implementation    // ALMA-compliant getAlarmById implementation
